...
Then open `http://127.0.0.1:8899/index.html?v=schedule-v1`.
...
- Finite-capacity campaign scheduler with multi-batch operation timing, setup/process/CIP windows, shared CIP/SIP skid constraints, equipment occupancy, hold-time warnings, QC release queue, bottleneck resources, and downloadable schedule/resource CSV files
